...
@section('title', 'Add New Furniture')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('user.furniture.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            <a href="{{ route('user.furniture.index') }}" class="btn btn-secondary me-md-2">
                                <i class="fas fa-arrow-left me-1"></i> Cancel
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> Save Furniture
                            </button>
                        </div>
                    </form>
                </div>
